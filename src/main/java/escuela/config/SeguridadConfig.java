    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http,
        ...
        return http
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .hasAnyAuthority("PAGO_LEER", "PAGO_REGISTRAR", "PAGO_VALIDAR", "PAGO_DEVOLVER")
                        ...
                        .requestMatchers("/admin/catalogos/pagos/**").hasAnyAuthority("PAGO_LEER", "PAGO_REGISTRAR", "PAGO_VALIDAR", "PAGO_DEVOLVER")
