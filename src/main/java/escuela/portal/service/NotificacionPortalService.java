...
public class NotificacionPortalService {
    ...
    public PortalNotificaciones sincronizarYConsultar(UsuarioPrincipal principal,int pagina){
        ...
        portal.sincronizar(principal.usuarioId(),principal.institucionId(),hoy,hoy.minusDays(30).atStartOfDay(zona).toInstant(),ahora);
    ...
    public String marcarLeida(UsuarioPrincipal principal,Long id){
        ...
        boolean accesible=n.getTipo()==TipoNotificacion.EVENTO
                ? portal.eventoAccesible(principal.usuarioId(),principal.institucionId(),n.getEvento().getId(),hoy)
                : portal.avisoAccesible(principal.usuarioId(),principal.institucionId(),n.getAviso().getId(),hoy,ahora);
        ...
        repository.saveAndFlush(n);return n.getTipo()==TipoNotificacion.EVENTO?"agenda":"avisos";
    }
